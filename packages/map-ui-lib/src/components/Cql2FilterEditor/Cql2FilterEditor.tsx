import type { Cql2FilterConfig, AvailableProperty, SortField } from '../../types';
...
export function Cql2FilterEditor({ value, onChange, availableProperties }: Cql2FilterEditorProps) {
  if (!value) {
    return (
